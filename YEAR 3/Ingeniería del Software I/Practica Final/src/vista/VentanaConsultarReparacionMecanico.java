...
import controlador.ControladorConsultaReparaciones;
import controlador.ControladorInicioMecanico;
import modelo.vo.ReparacionVO;
import modelo.vo.UsuarioVO;
import javax.swing.JButton;

public class VentanaConsultarReparacionMecanico extends JFrame{
	...
	public VentanaConsultarReparacionMecanico(ArrayList<ReparacionVO> listaReparaciones, String value, UsuarioVO usuario) {

		this.listaReparaciones=listaReparaciones;
		this.value=value;
		this.usuario=usuario;
		setBounds(130, 130, 1085, 465);
	...
	public void setControlador() {
		ControladorConsultaReparaciones control =new ControladorConsultaReparaciones(VentanaConsultarReparacionMecanico.this,usuario,listaReparaciones,value);
		control.setBoton();
	}
	...
	public void inicializar() {
		...
		lblReparacion.setBounds(98, 103, 303, 183);
		...
		JLabel lblRegistro = new JLabel("Historial Reparaciones");
		lblRegistro.setFont(new Font("Tahoma", Font.PLAIN, 17));
		lblRegistro.setBounds(806, 10, 205, 97);
		getContentPane().add(lblRegistro);
		
		
		JLabel lblidReparacion = new JLabel("idReparacion");
		...
		JLabel lblMatriculoVehiculo = new JLabel("MatriculaVehiculo");
		lblMatriculoVehiculo.setBounds(613, 103, 116, 40);
		getContentPane().add(lblMatriculoVehiculo);
		
		
		JLabel lblidFactura = new JLabel("TheIdFactura");
		...
		JLabel lblNifmecanico = new JLabel("NifMecanico");
		lblNifmecanico.setBounds(620, 203, 77, 40);
		getContentPane().add(lblNifmecanico);
		
		JLabel lblNifcliente = new JLabel("NifCliente");
		lblNifcliente.setBounds(719, 203, 77, 40);
		getContentPane().add(lblNifcliente);
		...
		btnReparar.setBounds(169, 327, 159, 46);
	...
	public void setBtnReparar(JButton btnReparar) {
		this.btnReparar = btnReparar;
	}
