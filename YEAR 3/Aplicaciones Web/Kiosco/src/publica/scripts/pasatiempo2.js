        ...
        switch(fila){
            case 1:
                if(palabraEscrita(1,4)){
                    ...
                    if(existePalabra(palabra)){
                        if((document.getElementById("letra1").value.toUpperCase()=="C") && (document.getElementById("letra2").value.toUpperCase()=="O") && (document.getElementById("letra3").value.toUpperCase()=="L") && (document.getElementById("letra4").value.toUpperCase()=="A")){
                            verdePalabra(1,4);
                        }else{
                            rojoPalabra(1,4);
                        }
            ...
            case 6:
                if(palabraEscrita(21,4)){
                    ...
                    if(existePalabra(palabra)){//Compruebo que la palabra esta en el diccionario
                        if((document.getElementById("letra21").value.toUpperCase()=="P") && (document.getElementById("letra22").value.toUpperCase()=="A") && (document.getElementById("letra23").value.toUpperCase()=="T") && (document.getElementById("letra24").value.toUpperCase()=="A")){
                            verdePalabra(21,4);
                        }else{
                            rojoPalabra(21,4);
                        }
        ...
        switch(fila){
            case 7:
                if(palabraEscrita(25,6)){
                    ...
                    if(existePalabra(palabra)){//Compruebo que la palabra esta en el diccionario
                        if((document.getElementById("letra25").value.toUpperCase()=="C") && (document.getElementById("letra26").value.toUpperCase()=="U") && (document.getElementById("letra27").value.toUpperCase()=="A") && (document.getElementById("letra28").value.toUpperCase()=="T") && (document.getElementById("letra29").value.toUpperCase()=="R") && (document.getElementById("letra30").value.toUpperCase()=="O")){
                            verdePalabra(25,6);
                        }else{
                            rojoPalabra(25,6);
                        }
            ...
            case 12:
                if(palabraEscrita(55,6)){
                    ...
                    if(existePalabra(palabra)){//Compruebo que la palabra esta en el diccionario
                        if((document.getElementById("letra55").value.toUpperCase()=="C") && (document.getElementById("letra56").value.toUpperCase()=="U") && (document.getElementById("letra57").value.toUpperCase()=="A") && (document.getElementById("letra58").value.toUpperCase()=="D") && (document.getElementById("letra59").value.toUpperCase()=="R") && (document.getElementById("letra60").value.toUpperCase()=="E")){
                            verdePalabra(55,6);
                        }else{
                            rojoPalabra(55,6);
                        }
...
function muestraSolucion(){
    ...
    document.getElementById("2letra1").value="C";
    document.getElementById("2letra2").value="O";
    document.getElementById("2letra3").value="L";
    document.getElementById("2letra4").value="A";

    document.getElementById("2letra5").value="C";
    document.getElementById("2letra6").value="O";
    document.getElementById("2letra7").value="P";
    document.getElementById("2letra8").value="A";

    document.getElementById("2letra9").value="C";
    document.getElementById("2letra10").value="A";
    document.getElementById("2letra11").value="P";
    document.getElementById("2letra12").value="O";

    document.getElementById("2letra13").value="C";
    document.getElementById("2letra14").value="A";
    document.getElementById("2letra15").value="P";
    document.getElementById("2letra16").value="A";

    document.getElementById("2letra17").value="P";
    document.getElementById("2letra18").value="A";
    document.getElementById("2letra19").value="C";
    document.getElementById("2letra20").value="A";

    document.getElementById("2letra21").value="P";
    document.getElementById("2letra22").value="A";
    document.getElementById("2letra23").value="T";
    document.getElementById("2letra24").value="A";

    document.getElementById("2letra25").value="C";
    document.getElementById("2letra26").value="U";
    document.getElementById("2letra27").value="A";
    document.getElementById("2letra28").value="T";
    document.getElementById("2letra29").value="R";
    document.getElementById("2letra30").value="O";

    document.getElementById("2letra31").value="C";
    document.getElementById("2letra32").value="U";
    document.getElementById("2letra33").value="A";
    document.getElementById("2letra34").value="D";
    document.getElementById("2letra35").value="R";
    document.getElementById("2letra36").value="O";

    document.getElementById("2letra37").value="C";
    document.getElementById("2letra38").value="U";
    document.getElementById("2letra39").value="R";
    document.getElementById("2letra40").value="A";
    document.getElementById("2letra41").value="D";
    document.getElementById("2letra42").value="O";

    document.getElementById("2letra43").value="C";
    document.getElementById("2letra44").value="U";
    document.getElementById("2letra45").value="R";
    document.getElementById("2letra46").value="A";
    document.getElementById("2letra47").value="D";
    document.getElementById("2letra48").value="A";

    document.getElementById("2letra49").value="C";
    document.getElementById("2letra50").value="U";
    document.getElementById("2letra51").value="A";
    document.getElementById("2letra52").value="D";
    document.getElementById("2letra53").value="R";
    document.getElementById("2letra54").value="A";

    document.getElementById("2letra55").value="C";
    document.getElementById("2letra56").value="U";
    document.getElementById("2letra57").value="A";
    document.getElementById("2letra58").value="D";
    document.getElementById("2letra59").value="R";
    document.getElementById("2letra60").value="E";
