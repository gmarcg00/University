...
function muestraSolucion(){
    ...
    document.getElementById("2letra2").value="L";
    document.getElementById("2letra3").value="A";
    document.getElementById("2letra4").value="N";

    document.getElementById("2letra5").value="C";
    document.getElementById("2letra6").value="I";
    document.getElementById("2letra7").value="A";
    document.getElementById("2letra8").value="N";

    document.getElementById("2letra9").value="N";
    document.getElementById("2letra10").value="A";
    document.getElementById("2letra11").value="C";
    document.getElementById("2letra12").value="Í";

    document.getElementById("2letra13").value="N";
    document.getElementById("2letra14").value="A";
    document.getElementById("2letra15").value="C";
    document.getElementById("2letra16").value="E";

    document.getElementById("2letra17").value="C";
    document.getElementById("2letra18").value="E";
    document.getElementById("2letra19").value="N";
    document.getElementById("2letra20").value="A";

    document.getElementById("2letra21").value="P";
    document.getElementById("2letra22").value="E";
    document.getElementById("2letra23").value="N";
    document.getElementById("2letra24").value="A";

    document.getElementById("2letra25").value="R";
    document.getElementById("2letra26").value="E";
    document.getElementById("2letra27").value="M";
    document.getElementById("2letra28").value="A";
    document.getElementById("2letra29").value="T";
    document.getElementById("2letra30").value="O";

    document.getElementById("2letra31").value="R";
    document.getElementById("2letra32").value="E";
    document.getElementById("2letra33").value="M";
    document.getElementById("2letra34").value="O";
    document.getElementById("2letra35").value="T";
    document.getElementById("2letra36").value="O";

    document.getElementById("2letra37").value="M";
    document.getElementById("2letra38").value="O";
    document.getElementById("2letra39").value="T";
    document.getElementById("2letra40").value="E";
    document.getElementById("2letra41").value="R";
    document.getElementById("2letra42").value="O";

    document.getElementById("2letra43").value="L";
    document.getElementById("2letra44").value="O";
    document.getElementById("2letra45").value="T";
    document.getElementById("2letra46").value="E";
    document.getElementById("2letra47").value="R";
    document.getElementById("2letra48").value="O";

    document.getElementById("2letra49").value="T";
    document.getElementById("2letra50").value="O";
    document.getElementById("2letra51").value="L";
    document.getElementById("2letra52").value="E";
    document.getElementById("2letra53").value="R";
    document.getElementById("2letra54").value="O";

    document.getElementById("2letra55").value="T";
    document.getElementById("2letra56").value="O";
    document.getElementById("2letra57").value="R";
    document.getElementById("2letra58").value="E";
    document.getElementById("2letra59").value="R";
    document.getElementById("2letra60").value="O";
