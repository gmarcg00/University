...
function rellenaBordeColumna(){
    if(contieneLetra()){
        for(var i=1;i<24;i+=4){
            document.getElementById("letra"+i).setAttribute("style","background:red; width:30px ; height: 30px ;text-transform: uppercase")
        }
...
function contieneLetra(){
    ...
    var tabla2=false;
    for(var i=1;i<24;i+=4){
        if(document.getElementById("letra"+i).value=="Ñ" || document.getElementById("letra"+i).value=="ñ" ){
            tabla1=true;
        }
    }
    for(var i=25;i<60;i+=6){
...
function contieneLetraTabla2(){
    for(var i=25;i<=60;i+=7){
        if(document.getElementById("letra"+i).value=="Ñ".toUpperCase() || document.getElementById("letra"+i).value=="ñ"){
            return true;
        }
    }
    return false;
