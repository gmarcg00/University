...
function rellenaFila2(){
    if(document.getElementById("letra5").value!="" && document.getElementById("letra6").value!="" && document.getElementById("letra7").value!="" && document.getElementById("letra8").value!=""){
        document.getElementById("letra5").setAttribute("style","background:red ;width:30px ; height: 30px");
        document.getElementById("letra6").setAttribute("style","background:red; width:30px ; height: 30px");
        document.getElementById("letra7").setAttribute("style","background:red; width:30px ; height: 30px");
        document.getElementById("letra8").setAttribute("style","background:red; width:30px ; height: 30px");

        alert("Fila 2 completada");
