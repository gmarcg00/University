...
function letrasBomba(){
    var letras=document.getElementById("cuadroPista").value;
    if(letras.includes("B")){
        if(letras.includes("O")){
            if(letras.includes("M")){
