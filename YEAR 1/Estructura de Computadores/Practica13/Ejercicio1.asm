...
main:
	...
	move $t0, $v0	#Guarda en t0 el valor leido en el syscall anterior
	...
	bucle:
		...
		bgt $t1, $t0, fin	#Si el contador es mayor que el ultimo numero dado, salta a la etiqueta fin
