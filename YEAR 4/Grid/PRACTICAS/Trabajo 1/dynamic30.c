...
#pragma omp parallel private(i,j,x,y,count) num_threads(30) 
{  
...
#pragma omp parallel private(i,j,c_max) num_threads(30) 
{    
	/*
...
#pragma omp parallel private(i,j,r,g,b,c) num_threads(30) 
{
	  #pragma omp for schedule(dynamic,10)
	  for ( i = 0; i < m; i++ )
	  {
