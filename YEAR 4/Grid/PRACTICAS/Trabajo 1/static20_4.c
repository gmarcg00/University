...
#pragma omp parallel private(i,j,x,y,count) num_threads(20) 
{  
...
#pragma omp parallel private(i,j,c_max) num_threads(20) 
{    
	/*
...
#pragma omp parallel private(i,j,r,g,b,c) num_threads(20) 
{
	  #pragma omp for schedule(static,4)
	  for ( i = 0; i < m; i++ )
	  {
